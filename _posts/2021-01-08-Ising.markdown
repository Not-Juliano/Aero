...
fig.show()
```
With a ferromagenetic configuration You end up with some variation of the following 3 gifs. With the first being near critcal temperatures, the second being low temperature and the last being extrememly high temperatures.
