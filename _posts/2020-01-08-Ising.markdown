...
#
##Spin Dynamics
For every spin, if the change in the Hamiltonian is favorable  for the system (Meaning E<=0) Switch the spin, Or else switch this spin by a probability.

Probability is given by  the boltzmann factor: exp(-ΔE/kT)

Spins are given by their states, where up is +1, down is -1
